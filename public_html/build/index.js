...
var author$project$Config$serverUrl = 'ws://localhost:8080';
...
var author$project$CounterNet$Static$Types$MainMenu = {$: 'MainMenu'};
var author$project$CounterNet$Init$init = author$project$CounterNet$Static$Types$MainMenu;
var author$project$CounterNet$Static$Types$SMainMenu = function (a) {
	return {$: 'SMainMenu', a: a};
};
var author$project$CounterNet$Static$Init$init = author$project$CounterNet$Static$Types$SMainMenu(author$project$CounterNet$Init$init);
var author$project$Static$Types$CounterNet = function (a) {
	return {$: 'CounterNet', a: a};
};
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Static$Init$init = _Utils_Tuple2(
	author$project$Static$Types$CounterNet(author$project$CounterNet$Static$Init$init),
...
var author$project$CounterNet$Static$Types$External = function (a) {
	return {$: 'External', a: a};
};
var author$project$CounterNet$Static$Types$TDecrementCounter = {$: 'TDecrementCounter'};
var author$project$CounterNet$Static$Types$TGoToMainMenu = {$: 'TGoToMainMenu'};
var author$project$CounterNet$Static$Types$TIncrementCounter = {$: 'TIncrementCounter'};
var author$project$CounterNet$Static$Wrappers$CounterPlace$unwrap = function (msg) {
	switch (msg.$) {
		case 'GoToMainMenu':
			return author$project$CounterNet$Static$Types$External(author$project$CounterNet$Static$Types$TGoToMainMenu);
		case 'IncrementCounter':
			return author$project$CounterNet$Static$Types$External(author$project$CounterNet$Static$Types$TIncrementCounter);
		default:
			return author$project$CounterNet$Static$Types$External(author$project$CounterNet$Static$Types$TDecrementCounter);
	}
};
var author$project$CounterNet$Static$Types$TGoToCounterPlace = {$: 'TGoToCounterPlace'};
var author$project$CounterNet$Static$Wrappers$MainMenu$unwrap = function (msg) {
	return author$project$CounterNet$Static$Types$External(author$project$CounterNet$Static$Types$TGoToCounterPlace);
};
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$CounterNet$View$CounterPlace$subs = function (_n0) {
	return elm$core$Platform$Sub$none;
};
var author$project$CounterNet$View$MainMenu$subs = function (_n0) {
	return elm$core$Platform$Sub$none;
};
var elm$core$Platform$Sub$map = _Platform_map;
var author$project$CounterNet$Static$Subs$subs = function (model) {
	if (model.$ === 'SMainMenu') {
		var m = model.a;
		return A2(
			elm$core$Platform$Sub$map,
			author$project$CounterNet$Static$Wrappers$MainMenu$unwrap,
			author$project$CounterNet$View$MainMenu$subs(m));
	} else {
		var m = model.a;
		return A2(
			elm$core$Platform$Sub$map,
			author$project$CounterNet$Static$Wrappers$CounterPlace$unwrap,
			author$project$CounterNet$View$CounterPlace$subs(m));
	}
};
var author$project$Static$Types$CounterNetTrans = function (a) {
	return {$: 'CounterNetTrans', a: a};
};
var author$project$Static$Subs$subscriptions = function (model) {
	var m = model.a;
	return A2(
		elm$core$Platform$Sub$map,
		author$project$Static$Types$CounterNetTrans,
		author$project$CounterNet$Static$Subs$subs(m));
};
...
var author$project$CounterNet$Static$Types$MCounterDecremented = function (a) {
	return {$: 'MCounterDecremented', a: a};
};
var author$project$CounterNet$Static$Types$MCounterIncremented = function (a) {
	return {$: 'MCounterIncremented', a: a};
};
var author$project$CounterNet$Static$Types$MWentToCounterPlace = function (a) {
	return {$: 'MWentToCounterPlace', a: a};
};
var author$project$CounterNet$Static$Types$MWentToMainMenu = {$: 'MWentToMainMenu'};
...
var author$project$CounterNet$Static$Decode$decodeIncomingMessage = function (_n0) {
	var incomingmessageTxts = _n0.b;
	_n1$4:
	while (true) {
		if (incomingmessageTxts.b) {
			switch (incomingmessageTxts.a) {
				case 'MWentToCounterPlace':
					...
					return function (_n2) {
						...
						return function (_n4) {
							...
							var l5 = _n4.b;
							return _Utils_Tuple2(
								A2(author$project$Utils$Utils$rMap, author$project$CounterNet$Static$Types$MWentToCounterPlace, r4),
								l5);
						}(
							function () {
								if (l4.b) {
									var clientCounterDataTxt = l4.a;
									var ll4 = l4.b;
									return _Utils_Tuple2(
										A2(
											elm$core$Result$andThen,
											elm$core$Result$Ok,
											A3(author$project$Utils$Utils$decodeInt, -1000000, 1000000, clientCounterDataTxt)),
										ll4);
								} else {
									return _Utils_Tuple2(
						...
						_Utils_Tuple2(
							elm$core$Result$Err(''),
							rest));
				case 'MWentToMainMenu':
					var rest = incomingmessageTxts.b;
					return function (_n5) {
						var r3 = _n5.a;
						var l4 = _n5.b;
						return _Utils_Tuple2(
							elm$core$Result$Ok(author$project$CounterNet$Static$Types$MWentToMainMenu),
							l4);
					}(
						_Utils_Tuple2(
							elm$core$Result$Err(''),
							rest));
				case 'MCounterIncremented':
					var rest = incomingmessageTxts.b;
					return function (_n6) {
						var r3 = _n6.a;
						var l4 = _n6.b;
						return function (_n8) {
							...
							var l5 = _n8.b;
							return _Utils_Tuple2(
								A2(author$project$Utils$Utils$rMap, author$project$CounterNet$Static$Types$MCounterIncremented, r4),
								l5);
						}(
							function () {
								if (l4.b) {
				...
				case 'MCounterDecremented':
					...
					return function (_n9) {
						...
						return function (_n11) {
							...
							var l5 = _n11.b;
							return _Utils_Tuple2(
								A2(author$project$Utils$Utils$rMap, author$project$CounterNet$Static$Types$MCounterDecremented, r4),
								l5);
						}(
							function () {
								if (l4.b) {
...
var author$project$Static$Types$CounterNetInMsg = function (a) {
	return {$: 'CounterNetInMsg', a: a};
};
var author$project$Static$Decode$decodeIncomingMessage = F2(
	function (txt, clientNet) {
		return A2(
			author$project$Utils$Utils$rMap,
			author$project$Static$Types$CounterNetInMsg,
			author$project$CounterNet$Static$Decode$decodeIncomingMessage(
				_Utils_Tuple2(
					elm$core$Result$Err(''),
					A2(elm$core$String$split, '\u0000', txt))).a);
	});
var author$project$Static$Version$version = 'v0.1';
...
var author$project$CounterNet$Static$Encode$encodeOutgoingTransition = function (outgoingtransition) {
	switch (outgoingtransition.$) {
		case 'TGoToCounterPlace':
...
var author$project$CounterNet$Static$Encode$encodeTransition = function (trans) {
	var ext = trans.a;
	return elm$core$Maybe$Just(
		author$project$CounterNet$Static$Encode$encodeOutgoingTransition(ext));
};
var author$project$Static$Encode$encodeTransition = function (netTrans) {
	var msg = netTrans.a;
	return author$project$CounterNet$Static$Encode$encodeTransition(msg);
};
var author$project$CounterNet$Static$Update$outgoingToIncoming = function (trans) {
	return elm$core$Maybe$Nothing;
};
...
var author$project$Static$Update$outgoingToIncoming = function (trans) {
	...
	return A2(
		elm$core$Maybe$map,
		author$project$Static$Types$CounterNetInMsg,
		author$project$CounterNet$Static$Update$outgoingToIncoming(tr));
};
var author$project$CounterNet$Static$Types$CounterDecremented = function (a) {
	return {$: 'CounterDecremented', a: a};
};
var author$project$CounterNet$Static$Types$CounterIncremented = function (a) {
	return {$: 'CounterIncremented', a: a};
};
var author$project$CounterNet$Static$Types$SCounterPlace = function (a) {
	return {$: 'SCounterPlace', a: a};
};
var author$project$CounterNet$Static$Types$WentToCounterPlace = function (a) {
	return {$: 'WentToCounterPlace', a: a};
};
var author$project$CounterNet$Static$Types$WentToMainMenu = {$: 'WentToMainMenu'};
var author$project$CounterNet$Static$Types$CounterPlace = function (a) {
	return {$: 'CounterPlace', a: a};
};
var author$project$CounterNet$Update$updateCounterPlaceCounterDecrementedCounterPlace = F3(
	function (fsp, _n0, counterPlace) {
		var clientCounterData = _n0.a;
		return author$project$CounterNet$Static$Types$CounterPlace(clientCounterData);
	});
var author$project$CounterNet$Update$updateCounterPlaceCounterIncrementedCounterPlace = F3(
	function (fsp, _n0, counterPlace) {
		var clientCounterData = _n0.a;
		return author$project$CounterNet$Static$Types$CounterPlace(clientCounterData);
	});
var author$project$CounterNet$Update$updateCounterPlaceWentToMainMenuMainMenu = F3(
	function (fsp, _n0, counterPlace) {
		return author$project$CounterNet$Static$Types$MainMenu;
	});
var author$project$CounterNet$Update$updateMainMenuWentToCounterPlaceCounterPlace = F3(
	function (fsp, _n0, mainMenu) {
		var clientCounterData = _n0.a;
		return author$project$CounterNet$Static$Types$CounterPlace(clientCounterData);
	});
var author$project$CounterNet$Static$Update$update = F3(
	function (fsp, trans, state) {
		var _n0 = _Utils_Tuple2(trans, state);
		_n0$4:
		while (true) {
			if (_n0.b.$ === 'SMainMenu') {
				if (_n0.a.$ === 'MWentToCounterPlace') {
					var clientCounterData = _n0.a.a;
					var st = _n0.b.a;
					return _Utils_Tuple2(
						author$project$CounterNet$Static$Types$SCounterPlace(
							A3(
								author$project$CounterNet$Update$updateMainMenuWentToCounterPlaceCounterPlace,
								fsp,
								author$project$CounterNet$Static$Types$WentToCounterPlace(clientCounterData),
								st)),
						elm$core$Platform$Cmd$none);
				} else {
					break _n0$4;
				...
				switch (_n0.a.$) {
					case 'MWentToMainMenu':
						...
						var st = _n0.b.a;
						return _Utils_Tuple2(
							author$project$CounterNet$Static$Types$SMainMenu(
								A3(author$project$CounterNet$Update$updateCounterPlaceWentToMainMenuMainMenu, fsp, author$project$CounterNet$Static$Types$WentToMainMenu, st)),
							elm$core$Platform$Cmd$none);
					case 'MCounterIncremented':
						var clientCounterData = _n0.a.a;
						var st = _n0.b.a;
						return _Utils_Tuple2(
							author$project$CounterNet$Static$Types$SCounterPlace(
								A3(
									author$project$CounterNet$Update$updateCounterPlaceCounterIncrementedCounterPlace,
									fsp,
									author$project$CounterNet$Static$Types$CounterIncremented(clientCounterData),
									st)),
							elm$core$Platform$Cmd$none);
					case 'MCounterDecremented':
						var clientCounterData = _n0.a.a;
						...
						return _Utils_Tuple2(
							author$project$CounterNet$Static$Types$SCounterPlace(
								A3(
									author$project$CounterNet$Update$updateCounterPlaceCounterDecrementedCounterPlace,
									fsp,
									author$project$CounterNet$Static$Types$CounterDecremented(clientCounterData),
									st)),
							elm$core$Platform$Cmd$none);
					default:
						break _n0$4;
...
var author$project$Static$Update$update = F3(
	function (tld, netInMsg, state) {
		...
		var msg = _n0.a.a;
		var m = _n0.b.a;
		var _n1 = A3(author$project$CounterNet$Static$Update$update, tld, msg, m);
		var newCounterNetState = _n1.a;
		var mcmd = _n1.b;
		var newClientState = author$project$Static$Types$CounterNet(newCounterNetState);
		return _Utils_Tuple2(
			newClientState,
			A2(elm$core$Platform$Cmd$map, author$project$Static$Types$CounterNetTrans, mcmd));
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				...
				var _n3 = _Utils_Tuple2(respTxt, newTrans);
				_n3$2:
				while (true) {
					if (_n3.a.$ === 'Just') {
						if (_n3.b.$ === 'Nothing') {
...
var author$project$CounterNet$View$CounterPlace$title = function (counterPlace) {
	return 'COUNTING IS EXCITING';
};
var author$project$CounterNet$View$MainMenu$title = function (mainMenu) {
	return 'Simple Counter App';
};
var author$project$CounterNet$Static$View$title = function (ns) {
	if (ns.$ === 'SMainMenu') {
		var m = ns.a;
		return author$project$CounterNet$View$MainMenu$title(m);
	} else {
		var m = ns.a;
		return author$project$CounterNet$View$CounterPlace$title(m);
	}
};
var author$project$Static$View$title = function (model) {
	var m = model.a;
	return author$project$CounterNet$Static$View$title(m);
};
...
var author$project$CounterNet$Static$Types$CounterPlace$DecrementCounter = {$: 'DecrementCounter'};
var author$project$CounterNet$Static$Types$CounterPlace$GoToMainMenu = {$: 'GoToMainMenu'};
var author$project$CounterNet$Static$Types$CounterPlace$IncrementCounter = {$: 'IncrementCounter'};
...
var author$project$CounterNet$View$CounterPlace$view = function (_n0) {
	var counter = _n0.a;
	return A2(
		elm$html$Html$div,
		_List_Nil,
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								A2(
								MacCASOutreach$graphicsvg$GraphicSVG$filled,
								(counter < 0) ? MacCASOutreach$graphicsvg$GraphicSVG$blue : MacCASOutreach$graphicsvg$GraphicSVG$red,
								MacCASOutreach$graphicsvg$GraphicSVG$circle(
									elm$core$Basics$abs(counter)))
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$CounterNet$Static$Types$CounterPlace$DecrementCounter)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('-')
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$CounterNet$Static$Types$CounterPlace$IncrementCounter)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('+')
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$CounterNet$Static$Types$CounterPlace$GoToMainMenu)
							]),
						_List_fromArray(
							[
...
var author$project$CounterNet$Static$Types$MainMenu$GoToCounterPlace = {$: 'GoToCounterPlace'};
var elm$html$Html$h1 = _VirtualDom_node('h1');
var author$project$CounterNet$View$MainMenu$view = function (mainMenu) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('A Simple Multiplayer Counting App')
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$CounterNet$Static$Types$MainMenu$GoToCounterPlace)
					]),
				_List_fromArray(
					[
...
var author$project$CounterNet$Static$View$view = function (ns) {
	if (ns.$ === 'SMainMenu') {
		var m = ns.a;
		return A2(
			elm$html$Html$map,
			author$project$CounterNet$Static$Wrappers$MainMenu$unwrap,
			author$project$CounterNet$View$MainMenu$view(m));
	} else {
		var m = ns.a;
		return A2(
			elm$html$Html$map,
			author$project$CounterNet$Static$Wrappers$CounterPlace$unwrap,
			author$project$CounterNet$View$CounterPlace$view(m));
	}
};
var author$project$Static$View$view = function (model) {
	...
	return A2(
		elm$html$Html$map,
		author$project$Static$Types$CounterNetTrans,
		author$project$CounterNet$Static$View$view(m));
};
