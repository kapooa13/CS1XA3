...
var author$project$KeyboardNet$Static$Types$Keyboard = {$: 'Keyboard'};
var author$project$KeyboardNet$Init$init = author$project$KeyboardNet$Static$Types$Keyboard;
var author$project$KeyboardNet$Static$Types$SKeyboard = function (a) {
	return {$: 'SKeyboard', a: a};
};
var author$project$KeyboardNet$Static$Init$init = author$project$KeyboardNet$Static$Types$SKeyboard(author$project$KeyboardNet$Init$init);
var author$project$Static$Types$KeyboardNet = function (a) {
	return {$: 'KeyboardNet', a: a};
};
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Static$Init$init = _Utils_Tuple2(
	author$project$Static$Types$KeyboardNet(author$project$KeyboardNet$Static$Init$init),
...
var author$project$KeyboardNet$Static$Types$External = function (a) {
	return {$: 'External', a: a};
};
var author$project$KeyboardNet$Static$Types$Internal = function (a) {
	return {$: 'Internal', a: a};
};
var author$project$KeyboardNet$Static$Types$TNoOp = {$: 'TNoOp'};
var author$project$KeyboardNet$Static$Types$TSomeKeyPressed = function (a) {
	return {$: 'TSomeKeyPressed', a: a};
};
var author$project$KeyboardNet$Static$Wrappers$Keyboard$unwrap = function (msg) {
	if (msg.$ === 'SomeKeyPressed') {
		var myKeyInteger = msg.a;
		return author$project$KeyboardNet$Static$Types$External(
			author$project$KeyboardNet$Static$Types$TSomeKeyPressed(myKeyInteger));
	} else {
		return author$project$KeyboardNet$Static$Types$Internal(author$project$KeyboardNet$Static$Types$TNoOp);
	}
};
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$KeyboardNet$View$Keyboard$subs = function (keyboard) {
	return elm$core$Platform$Sub$none;
};
var elm$core$Platform$Sub$map = _Platform_map;
var author$project$KeyboardNet$Static$Subs$subs = function (model) {
	var m = model.a;
	return A2(
		elm$core$Platform$Sub$map,
		author$project$KeyboardNet$Static$Wrappers$Keyboard$unwrap,
		author$project$KeyboardNet$View$Keyboard$subs(m));
};
var author$project$Static$Types$KeyboardNetTrans = function (a) {
	return {$: 'KeyboardNetTrans', a: a};
};
var author$project$Static$Subs$subscriptions = function (model) {
	var m = model.a;
	return A2(
		elm$core$Platform$Sub$map,
		author$project$Static$Types$KeyboardNetTrans,
		author$project$KeyboardNet$Static$Subs$subs(m));
};
...
var author$project$KeyboardNet$Static$Types$MKeyUnpressed = function (a) {
	return {$: 'MKeyUnpressed', a: a};
};
...
var author$project$KeyboardNet$Static$Decode$decodeIncomingMessage = function (_n0) {
	var incomingmessageTxts = _n0.b;
	if (incomingmessageTxts.b && (incomingmessageTxts.a === 'MKeyUnpressed')) {
		...
		return function (_n2) {
			...
			return function (_n4) {
				...
				var l5 = _n4.b;
				return _Utils_Tuple2(
					A2(author$project$Utils$Utils$rMap, author$project$KeyboardNet$Static$Types$MKeyUnpressed, r4),
					l5);
			}(
				function () {
					if (l4.b) {
						var myKeyIntegerTxt = l4.a;
						var ll4 = l4.b;
						return _Utils_Tuple2(
							A2(
								elm$core$Result$andThen,
								elm$core$Result$Ok,
								A3(author$project$Utils$Utils$decodeInt, 0, 10, myKeyIntegerTxt)),
							ll4);
					} else {
						return _Utils_Tuple2(
...
var author$project$Static$Types$KeyboardNetInMsg = function (a) {
	return {$: 'KeyboardNetInMsg', a: a};
};
var author$project$Static$Decode$decodeIncomingMessage = F2(
	function (txt, clientNet) {
		return A2(
			author$project$Utils$Utils$rMap,
			author$project$Static$Types$KeyboardNetInMsg,
			author$project$KeyboardNet$Static$Decode$decodeIncomingMessage(
				_Utils_Tuple2(
					elm$core$Result$Err(''),
					A2(elm$core$String$split, '\u0000', txt))).a);
	});
var author$project$Static$Version$version = 'v1555361100948650';
...
var author$project$KeyboardNet$Static$Encode$encodeOutgoingTransition = function (outgoingtransition) {
	var myKeyInteger = outgoingtransition.a;
	var myKeyIntegerTxt = A3(author$project$Utils$Utils$encodeInt, 0, 10, myKeyInteger);
	return author$project$Utils$Utils$tConcat(
		_List_fromArray(
			['TSomeKeyPressed\u0000', myKeyIntegerTxt]));
};
var author$project$KeyboardNet$Static$Encode$encodeTransition = function (trans) {
	if (trans.$ === 'Internal') {
		return elm$core$Maybe$Nothing;
	} else {
		var ext = trans.a;
		return elm$core$Maybe$Just(
			author$project$KeyboardNet$Static$Encode$encodeOutgoingTransition(ext));
	}
};
var author$project$Static$Encode$encodeTransition = function (netTrans) {
	var msg = netTrans.a;
	return author$project$KeyboardNet$Static$Encode$encodeTransition(msg);
};
var author$project$KeyboardNet$Static$Types$MNoOp = {$: 'MNoOp'};
...
var author$project$KeyboardNet$Static$Update$outgoingToIncoming = function (trans) {
	if (trans.$ === 'Internal') {
		var _n1 = trans.a;
		return author$project$Utils$Utils$Left(author$project$KeyboardNet$Static$Types$MNoOp);
	} else {
		var outT = trans.a;
		return author$project$Utils$Utils$Right(
			author$project$KeyboardNet$Static$Types$External(outT));
	}
};
...
var author$project$Static$Update$outgoingToIncoming = function (trans) {
	...
	return A3(
		...
		author$project$Static$Types$KeyboardNetInMsg,
		author$project$Static$Types$KeyboardNetTrans,
		author$project$KeyboardNet$Static$Update$outgoingToIncoming(tr));
};
var author$project$KeyboardNet$Static$Types$KeyUnpressed = function (a) {
	return {$: 'KeyUnpressed', a: a};
};
var author$project$KeyboardNet$Static$Types$NoOp = {$: 'NoOp'};
var author$project$KeyboardNet$Static$Wrappers$unwrapNoOp = function (_n0) {
	return author$project$KeyboardNet$Static$Types$TNoOp;
};
var author$project$KeyboardNet$Sound$play = _Platform_outgoingPort('play', elm$core$Basics$identity);
var author$project$KeyboardNet$Sound$playSound = function (url) {
	return author$project$KeyboardNet$Sound$play(
		elm$json$Json$Encode$string(url));
};
var author$project$KeyboardNet$Update$updateKeyboardKeyUnpressedKeyboard = F3(
	function (fsp, _n0, keyboard) {
		var myKeyInt = _n0.a;
		switch (myKeyInt) {
			case 0:
				return _Utils_Tuple2(
					author$project$KeyboardNet$Static$Types$Keyboard,
					author$project$KeyboardNet$Sound$playSound('https://s3.amazonaws.com/freecodecamp/simonSound1.mp3'));
			case 1:
				return _Utils_Tuple2(
					author$project$KeyboardNet$Static$Types$Keyboard,
					author$project$KeyboardNet$Sound$playSound('https://s3.amazonaws.com/freecodecamp/simonSound2.mp3'));
			default:
				return _Utils_Tuple2(author$project$KeyboardNet$Static$Types$Keyboard, elm$core$Platform$Cmd$none);
		}
	});
var author$project$KeyboardNet$Update$updateNoOpKeyboard = F3(
	function (fsp, _n0, keyboard) {
		return keyboard;
	});
...
var author$project$KeyboardNet$Static$Update$update = F3(
	function (fsp, trans, state) {
		var _n0 = _Utils_Tuple2(trans, state);
		if (_n0.a.$ === 'MKeyUnpressed') {
			var myKeyInteger = _n0.a.a;
			var st = _n0.b.a;
			var _n1 = A3(
				author$project$KeyboardNet$Update$updateKeyboardKeyUnpressedKeyboard,
				fsp,
				author$project$KeyboardNet$Static$Types$KeyUnpressed(myKeyInteger),
				st);
			var newModel = _n1.a;
			var cmd = _n1.b;
			return _Utils_Tuple2(
				author$project$KeyboardNet$Static$Types$SKeyboard(newModel),
				A2(
					elm$core$Platform$Cmd$map,
					A2(elm$core$Basics$composeL, author$project$KeyboardNet$Static$Types$Internal, author$project$KeyboardNet$Static$Wrappers$unwrapNoOp),
					cmd));
		} else {
			var _n2 = _n0.a;
			var st = _n0.b.a;
			return _Utils_Tuple2(
				author$project$KeyboardNet$Static$Types$SKeyboard(
					A3(author$project$KeyboardNet$Update$updateNoOpKeyboard, fsp, author$project$KeyboardNet$Static$Types$NoOp, st)),
				elm$core$Platform$Cmd$none);
		}
	});
var author$project$Static$Update$update = F3(
	function (tld, netInMsg, state) {
		...
		var msg = _n0.a.a;
		var m = _n0.b.a;
		var _n1 = A3(author$project$KeyboardNet$Static$Update$update, tld, msg, m);
		var newKeyboardNetState = _n1.a;
		var mcmd = _n1.b;
		var newClientState = author$project$Static$Types$KeyboardNet(newKeyboardNetState);
		return _Utils_Tuple2(
			newClientState,
			A2(elm$core$Platform$Cmd$map, author$project$Static$Types$KeyboardNetTrans, mcmd));
	});
...
var author$project$KeyboardNet$View$Keyboard$title = function (keyboard) {
	return 'oh God please let this work';
};
var author$project$KeyboardNet$Static$View$title = function (ns) {
	var m = ns.a;
	return author$project$KeyboardNet$View$Keyboard$title(m);
};
var author$project$Static$View$title = function (model) {
	var m = model.a;
	return author$project$KeyboardNet$Static$View$title(m);
};
var author$project$KeyboardNet$Static$Types$Keyboard$SomeKeyPressed = function (a) {
	return {$: 'SomeKeyPressed', a: a};
};
var author$project$KeyboardNet$View$Keyboard$view = function (keyboard) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$KeyboardNet$Static$Types$Keyboard$SomeKeyPressed(0))
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Sound 0')
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								author$project$KeyboardNet$Static$Types$Keyboard$SomeKeyPressed(1))
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Sound 1')
							]))
					]))
			]));
};
...
var author$project$KeyboardNet$Static$View$view = function (ns) {
	var m = ns.a;
	return A2(
		elm$html$Html$map,
		author$project$KeyboardNet$Static$Wrappers$Keyboard$unwrap,
		author$project$KeyboardNet$View$Keyboard$view(m));
};
var author$project$Static$View$view = function (model) {
	...
	return A2(
		elm$html$Html$map,
		author$project$Static$Types$KeyboardNetTrans,
		author$project$KeyboardNet$Static$View$view(m));
};
