...
updateKeyboardChangedColorNumberKeyboard : FromSuperPlace -> ChangedColorNumber -> Keyboard -> (Keyboard,Cmd BoardKeyPressed)
updateKeyboardChangedColorNumberKeyboard fsp (ChangedColorNumber myColor)  (Keyboard clientKeyStateDict someCol cKCD) =
        (Keyboard clientKeyStateDict myColor cKCD, BoardKeyPressed cKCD myColor 20)
...
updateKeyboardRandomNumRolledKeyboard fsp RandomNumRolled  keyboard = 
        (keyboard, Random.generate RandomColorNumber (Random.int 0 24))
